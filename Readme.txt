...
can implement your own Java classes and run them without knowing the detail
of the platform.
...
The platform is like a referee of the game. Every step of the simulation begins
 after the platform has informed every player of the beginning of a new day.
 The players then need to ask the platform for the price information, and finally,
 submit a new price of the day to the platform to end its phase.

3.2. The platform interface

There are five methods that the platform provides for the players to call:
...
RemoteException, so that you know the failure of the connection.
Normally nothing will be done by this method. You may not need this method.
The platform provides this just in case you want to make your leader program
more robust.
...
follower as well as the cost of a given day. The Record is a public class
which contains the price and cost in it. This is a very important method
you may want to use in your own leader.
...
Publish your new price by calling this method. After calculating your profit
and get a optimal price, you need to call this method to finish your phase
 of this simulation day.
...
By calling this method you can publish some information (e.g. debug
...
An example of the use of this method can be found in SimpleLeader, after
calling which the program exits. You may make the choice whether override
this method or not.
...
The platform will call this method when the simulation ends. You may want to
do some finalization here, otherwise you don't need to override it.
...
This is the only method you *MUST* implement. Here you may want to ask the
platform of the price and cost of the day before the current day. You may
also put all your math stuff here to compute an optimal price. Your phase
will end after your done everything here.

3.4. Summary of what you need to do

You can find the pseudo-code of a leader in the directory that you may want
to follow. By implementing this code, you will get your own leader.
